...
export default function LandingPage() {
    ...
    return (
        <div className='min-h-screen bg-[#111] text-gray-100 font-sans selection:bg-blue-900/30 selection:text-blue-200 transition-colors duration-300'>
            {/* Navigation */}
            ...
            <main className='max-w-7xl mx-auto px-6 md:px-12 pt-16 pb-24 text-center md:text-left flex flex-col md:flex-row items-center gap-12'>
                <div className='flex-1 space-y-8'>
                    ...
                    >
                        <span className='inline-block px-4 py-1.5 bg-blue-900/10 text-blue-400 rounded-full text-xs font-bold uppercase tracking-wider mb-6 border border-blue-500/20'>
                            The Future of Video Calls
                        </span>
                        <h2 className='text-5xl md:text-7xl font-extrabold leading-[1.1] mb-6 text-white'>
                    ...
                    <div className='flex items-center gap-4 pt-4'>
                        <div className='flex -space-x-3'>
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className='w-10 h-10 rounded-full border-2 border-[#222] bg-white/5 overflow-hidden'>
                ...
                >
                    ...
                    {/* Decorative elements */}
                    <div className='absolute -top-12 -right-12 w-64 h-64 bg-blue-600/10 rounded-full blur-3xl -z-10 animate-pulse' />
                    <div className='absolute -bottom-12 -left-12 w-64 h-64 bg-purple-600/10 rounded-full blur-3xl -z-10' />
                </motion.div>
            </main>

            {/* Features Section */}
            <section className='bg-white/5 py-24 px-6 md:px-12 border-t border-white/5'>
                <div className='max-w-7xl mx-auto'>
                    <div className='text-center mb-16'>
                        <h3 className='text-3xl md:text-4xl font-bold mb-4 text-white'>Everything you need to connect</h3>
